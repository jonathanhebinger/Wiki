import { TemplateDataId, TemplateDataTrio, TemplateId, TemplatePair } from '@brainote/domain'
...
export type MyThunk<Model extends object, Payload = undefined, Result = any> = Thunk<
  Model,
  Payload,
  any,
  {},
